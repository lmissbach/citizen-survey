...
District.Code    <- read_csv(sprintf("%s/2_Codes/District.Code.csv",    path_0))
Province.Code    <- read_csv(sprintf("%s/2_Codes/Province.Code.csv",    path_0))
Urban.1.Code     <- read_csv(sprintf("%s/2_Codes/Urban.Code.1.csv",     path_0))
Urban.2.Code     <- read_csv(sprintf("%s/2_Codes/Urban.Code.2.csv",     path_0))
Gender.Code      <- read_csv(sprintf("%s/2_Codes/Gender.Code.csv",      path_0))
Nationality.Code <- read_csv(sprintf("%s/2_Codes/Nationality.Code.csv", path_0))
Education.Code   <- read_csv(sprintf("%s/2_Codes/Education.Code.csv",   path_0))
Occupation.Code  <- read_csv(sprintf("%s/2_Codes/Occupation.Code.csv",  path_0))
Industry.Code    <- read_csv(sprintf("%s/2_Codes/Industry.Code.csv",    path_0))
Tenant.Code      <- read_csv(sprintf("%s/2_Codes/Tenant.Code.csv",      path_0))
Housing.Code     <- read_csv(sprintf("%s/2_Codes/Housing.Code.csv",     path_0))
Water.Code       <- read_csv(sprintf("%s/2_Codes/Water.Code.csv",       path_0))
Heating.Code     <- read_csv(sprintf("%s/2_Codes/Heating.Code.csv",     path_0))

# 0.2.5 Supplementary data ####

exchange.rate  <- 1.12968118 # Source as usual
inflation.rate <- 1/1.01956 # Source: IMF
